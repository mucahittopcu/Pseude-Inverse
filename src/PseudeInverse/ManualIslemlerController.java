...
public class ManualIslemlerController implements Initializable {
    ...
    @FXML
    private RadioButton rb1, rb2, rb3, rb4, rb5, rb11, rb12, rb13, rb14, rb15;
    @FXML
    private TextField tv00, tv01, tv02, tv03, tv04, tv10, tv11, tv12, tv13, tv14, tv20, tv21, tv22, tv23, tv24, tv30, tv31, tv32, tv33, tv34, tv40, tv41, tv42, tv43, tv44;
    @FXML
    private Button geriButton, tersiniAlButton;
    @FXML
    ...
    public double[][] matrisTranspozFonk(double[][] a) {
    ...
    public double[][] matrisCarpımFonk(double[][] a, double[][] b) {
        ...
        for (int i = 0; i < mat1Satir; i++) {
            for (int j = 0; j < mat2Sutun; j++) {
                for (int k = 0; k < mat1Sutun; k++) {
                    ...
                    c[i][j] += a[i][k] * b[k][j];
                    prodcounter++;
                    System.out.println("C[" + i + "][" + j + "]=C[" + i + "][" + j + "]+A[" + i + "][" + k + "]*B[" + k + "][" + j + "] ==>" + c[i][j] + "=" + tut + "+" + a[i][k] + "*" + b[k][j]);
                    islemYazilacak += "C[" + i + "][" + j + "]=C[" + i + "][" + j + "]+A[" + i + "][" + k + "]*B[" + k + "][" + j + "] ==>" + c[i][j] + "=" + tut + "+" + a[i][k] + "*" + b[k][j] + "\n";
                }
            }
        }
        islemYazilacak += "\n";
    ...
    public double[][] matrisTersiFonk(double[][] gelenMatris) {
        ...
        islemYazilacak += "Verilen Matrisin Yanına Birim Matris Yazıyoruz\n";
        String[][] matrisBirlesikString = new String[n][2 * n];
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < 2 * n; j++) {
                matrisBirlesikString[i][j] = new DecimalFormat("##.######").format(birlesikMatris[i][j]);
                System.out.print(matrisBirlesikString[i][j] + " | ");
                islemYazilacak += matrisBirlesikString[i][j] + " | ";
            }
            System.out.println("");
            islemYazilacak += "\n";
        }
        ...
        islemYazilacak += "Elementer İşlemler Yapılıyor.\n";
        System.out.println("");
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                if (i != j) {
                    ...
                    prodcounter++;
                    for (int k = 0; k < 2 * n; k++) {
                        double tut = birlesikMatris[j][k];
                        birlesikMatris[j][k] -= oran * birlesikMatris[i][k];
                        System.out.println("İnv[" + j + "][" + k + "]=İnv[" + j + "][" + k + "]-ORAN*İnv[" + i + "][" + k + "] ==>" + birlesikMatris[j][k] + "=" + tut + "-" + oran + "*" + birlesikMatris[i][k]);
                        islemYazilacak += "İnv[" + j + "][" + k + "]=İnv[" + j + "][" + k + "]-ORAN*İnv[" + i + "][" + k + "] ==>" + birlesikMatris[j][k] + "=" + tut + "-" + oran + "*" + birlesikMatris[i][k];
                        islemYazilacak += "\n";
                        prodcounter++;
                        sumcounter++;
                    }
        ...
        islemYazilacak += "Köşegen matris oluşturuldu. Diğer Elemanlar 0 aldı.\n";
        String[][] matrisBirlesikString1 = new String[n][2 * n];
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < 2 * n; j++) {
                matrisBirlesikString1[i][j] = new DecimalFormat("##.######").format(birlesikMatris[i][j]);
                System.out.print(matrisBirlesikString1[i][j] + "|");
                islemYazilacak += matrisBirlesikString1[i][j] + "|";
            }
            System.out.println("");
            islemYazilacak += "\n";
        }
        ...
        islemYazilacak += "Köşegen Matrisin Koşegenlerinin 1 Yaparak Verilen Matrisi Birim Matris Yaptık\n";
        System.out.println("");
        String[][] matrisBirlesikString12 = new String[n][2 * n];
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < 2 * n; j++) {
                matrisBirlesikString12[i][j] = new DecimalFormat("##.######").format(birlesikMatris[i][j]);
                System.out.print(matrisBirlesikString12[i][j] + "|");
                islemYazilacak += matrisBirlesikString12[i][j] + "|";
            }
            islemYazilacak += "\n";
            System.out.println("");
        }
